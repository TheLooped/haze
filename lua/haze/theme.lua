...
theme.loadEditor = function()
	local editor = {
		...
		NonText = { fg = p.ash },
		Normal = { fg = p.frost, bg = p.eclipse },
		NormalNC = { fg = p.ash, bg = p.eclipse },
		NormalFloat = { fg = p.frost, bg = p.abyss },
		FloatBorder = { fg = p.periwinkle, bg = p.abyss },
		...
		StatusLine = { fg = p.frost, bg = p.abyss },
		StatusLineNC = { fg = p.ash, bg = p.abyss },
		Substitute = { bg = p.periwinkle, fg = p.frost },
		TabLine = { bg = p.smoke, fg = p.slate },
		TabLineFill = { bg = p.eclipse },
		TabLineSel = { fg = p.tidepool, bg = p.smoke },
...
theme.loadLsp = function()
	local lsp = {
		...
		DiagnosticInfo = { fg = p.ash },
		DiagnosticHint = { fg = p.ash },
		DiagnosticVirtualTextError = { fg = p.coral, style = "italic" },
		DiagnosticVirtualTextWarn = { fg = p.amber, style = "italic" },
		DiagnosticVirtualTextInfo = { fg = p.ash, style = "italic" },
		DiagnosticVirtualTextHint = { fg = p.ash, style = "italic" },
		...
		LspSignatureActiveParameter = { fg = p.periwinkle },
